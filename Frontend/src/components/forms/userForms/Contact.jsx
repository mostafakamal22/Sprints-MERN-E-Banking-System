...
export const Contact = () => {
  return (
    <div className="max-w-5xl w-full overflow-x-auto  p-6 bg-slate-50 rounded shadow-lg shadow-black/30">
      <h3 className="flex justify-center items-center text-3xl my-10 p-4 text-center font-bold bg-blue-200 text-gray-900 border-b-4 border-blue-800 rounded shadow">
